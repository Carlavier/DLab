  ...
  const features = [
    {
      icon: Building2,
      title: "Project-Based",
      description: "Các công ty tham gia theo dạng project-based, linh hoạt và hiệu quả"
    },
    {
      icon: Shield,
      title: "Chính sách Sandbox",
      description: "Được hưởng chính sách sandbox của thành phố về AI và công nghệ mới"
    },
    {
      icon: Zap,
      title: "Môi trường thử nghiệm",
      description: "Môi trường linh hoạt, giảm rào cản pháp lý, tăng tốc innovation"
    }
  ];

  return (
    <section id="about" className="py-32 bg-gradient-to-b from-black via-slate-900 to-black relative overflow-hidden">
      {/* Background Effects */}
        ...
        <ScrollAnimation>
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl mb-6 text-white">
              Giới thiệu <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent font-bold">DAB-Lab</span>
            </h2>
            <p className="text-xl text-slate-300 max-w-4xl mx-auto leading-relaxed">
              <span className="text-cyan-400 font-semibold">DAB-Lab (Da Nang AI & Blockchain Lab)</span> là không gian nghiên cứu và phát triển 
              đặt tại Trung tâm Phần mềm Đà Nẵng — hub công nghệ năng động nhất miền Trung Việt Nam.
            </p>
          </div>
        </ScrollAnimation>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-slate-300 leading-relaxed mb-8">
                  Chúng tôi tạo ra một hệ sinh thái đổi mới sáng tạo, nơi công nghệ blockchain và AI được nghiên cứu, 
                  phát triển và triển khai trong môi trường thuận lợi nhất.
                </p>
              </div>
              ...
              {features.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <h4 className="text-xl mb-2 text-white font-semibold">{feature.title}</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="relative group">
              ...
              <div className="relative bg-gradient-to-br from-slate-800/80 to-slate-900/80 p-8 rounded-2xl border border-cyan-500/30 hover:border-cyan-500/60 transition-all">
                ...
                <h3 className="text-2xl mb-3 text-white font-semibold">Artificial Intelligence</h3>
                <p className="text-slate-300 leading-relaxed">
                  Nghiên cứu và phát triển các giải pháp AI tiên tiến, machine learning, deep learning 
                  và natural language processing cho thị trường Việt Nam và khu vực.
                </p>
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-gradient-to-br from-slate-800/80 to-slate-900/80 p-8 rounded-2xl border border-blue-500/30 hover:border-blue-500/60 transition-all">
                ...
                <h3 className="text-2xl mb-3 text-white font-semibold">Blockchain Technology</h3>
                <p className="text-slate-300 leading-relaxed">
                  Xây dựng giải pháp blockchain an toàn, minh bạch và hiệu quả cho doanh nghiệp, 
                  smart contracts, DeFi và Web3 applications.
                </p>
              </div>
            </div>
          </div>
