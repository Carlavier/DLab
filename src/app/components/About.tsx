      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-4xl mb-6 text-gray-900 font-bold">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="text-center p-4 bg-white rounded-xl border border-green-200 shadow-md">
                <Award className="w-8 h-8 text-green-600 mx-auto mb-2" />
                <div className="text-2xl text-gray-900 font-bold mb-1">50+</div>
                <div className="text-sm text-gray-600">Projects</div>
              </div>
              <div className="text-center p-4 bg-white rounded-xl border border-green-200 shadow-md">
                <Users className="w-8 h-8 text-green-600 mx-auto mb-2" />
                <div className="text-2xl text-gray-900 font-bold mb-1">30+</div>
                <div className="text-sm text-gray-600">Researchers</div>
              </div>
              <div className="text-center p-4 bg-white rounded-xl border border-green-200 shadow-md">
                <Globe className="w-8 h-8 text-green-600 mx-auto mb-2" />
                <div className="text-2xl text-gray-900 font-bold mb-1">10+</div>
